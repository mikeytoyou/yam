 ...
 */
class TrCmsLang extends \alex\yamBundle\Entity\TrCmsLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'idCms', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'metaTitle', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'metaDescription', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'metaKeywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'content', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsLang' . "\0" . 'linkRewrite');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCmsLang $proxy) {
