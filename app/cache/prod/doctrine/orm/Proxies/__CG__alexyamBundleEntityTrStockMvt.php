 ...
 */
class TrStockMvt extends \alex\yamBundle\Entity\TrStockMvt implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idStockMvt', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idStock', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idOrder', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idSupplyOrder', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idStockMvtReason', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'idEmployee', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'employeeLastname', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'employeeFirstname', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'physicalQuantity', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'sign', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'priceTe', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'lastWa', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'currentWa', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvt' . "\0" . 'referer');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrStockMvt $proxy) {
