 ...
 */
class TrTab extends \alex\yamBundle\Entity\TrTab implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'idTab', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'idParent', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'className', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'module', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'position', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'active', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTab' . "\0" . 'hideHostMode');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrTab $proxy) {
    ...
    public function setHideHostMode($hideHostMode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHideHostMode', array($hideHostMode));

        return parent::setHideHostMode($hideHostMode);
    }
