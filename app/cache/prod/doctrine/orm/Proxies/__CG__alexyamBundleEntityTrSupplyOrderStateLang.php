 ...
 */
class TrSupplyOrderStateLang extends \alex\yamBundle\Entity\TrSupplyOrderStateLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderStateLang' . "\0" . 'idSupplyOrderState', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderStateLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderStateLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSupplyOrderStateLang $proxy) {
