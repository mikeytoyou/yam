 ...
 */
class TrStockAvailable extends \alex\yamBundle\Entity\TrStockAvailable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'idStockAvailable', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'idProductAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'idShopGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'quantity', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'dependsOnStock', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockAvailable' . "\0" . 'outOfStock');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrStockAvailable $proxy) {
    ...
    public function getIdStockAvailable()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdStockAvailable();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdStockAvailable', array());

        return parent::getIdStockAvailable();
    }
    ...
    public function setDependsOnStock($dependsOnStock)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDependsOnStock', array($dependsOnStock));

        return parent::setDependsOnStock($dependsOnStock);
    }
    ...
    public function getDependsOnStock()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDependsOnStock', array());

        return parent::getDependsOnStock();
    }
