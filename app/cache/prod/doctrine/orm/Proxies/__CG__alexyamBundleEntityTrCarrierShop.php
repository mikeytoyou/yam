 ...
 */
class TrCarrierShop extends \alex\yamBundle\Entity\TrCarrierShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierShop' . "\0" . 'idCarrier', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCarrierShop $proxy) {
