 ...
 */
class TrAttributeGroup extends \alex\yamBundle\Entity\TrAttributeGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeGroup' . "\0" . 'idAttributeGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeGroup' . "\0" . 'isColorGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeGroup' . "\0" . 'groupType', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeGroup' . "\0" . 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAttributeGroup $proxy) {
