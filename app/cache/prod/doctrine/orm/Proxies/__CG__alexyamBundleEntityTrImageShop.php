 ...
 */
class TrImageShop extends \alex\yamBundle\Entity\TrImageShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImageShop' . "\0" . 'idImage', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImageShop' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImageShop' . "\0" . 'cover');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrImageShop $proxy) {
