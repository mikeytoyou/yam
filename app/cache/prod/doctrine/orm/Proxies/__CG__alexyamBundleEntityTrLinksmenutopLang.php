 ...
 */
class TrLinksmenutopLang extends \alex\yamBundle\Entity\TrLinksmenutopLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLinksmenutopLang' . "\0" . 'idLinksmenutop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLinksmenutopLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLinksmenutopLang' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLinksmenutopLang' . "\0" . 'label', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLinksmenutopLang' . "\0" . 'link');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrLinksmenutopLang $proxy) {
