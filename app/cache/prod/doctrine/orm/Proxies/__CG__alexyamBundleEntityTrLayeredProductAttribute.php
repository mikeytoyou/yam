 ...
 */
class TrLayeredProductAttribute extends \alex\yamBundle\Entity\TrLayeredProductAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredProductAttribute' . "\0" . 'idAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredProductAttribute' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredProductAttribute' . "\0" . 'idAttributeGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredProductAttribute' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrLayeredProductAttribute $proxy) {
