 ...
 */
class TrAttributeShop extends \alex\yamBundle\Entity\TrAttributeShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeShop' . "\0" . 'idAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAttributeShop $proxy) {
