 ...
 */
class TrSupplyOrderHistory extends \alex\yamBundle\Entity\TrSupplyOrderHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'idSupplyOrderHistory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'idSupplyOrder', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'idEmployee', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'employeeLastname', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'employeeFirstname', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'idState', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplyOrderHistory' . "\0" . 'dateAdd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSupplyOrderHistory $proxy) {
    ...
    public function getIdSupplyOrderHistory()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdSupplyOrderHistory();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdSupplyOrderHistory', array());

        return parent::getIdSupplyOrderHistory();
    }
