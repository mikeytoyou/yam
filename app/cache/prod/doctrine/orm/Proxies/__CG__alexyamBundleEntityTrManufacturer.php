 ...
 */
class TrManufacturer extends \alex\yamBundle\Entity\TrManufacturer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturer' . "\0" . 'idManufacturer', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturer' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturer' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturer' . "\0" . 'dateUpd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturer' . "\0" . 'active');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrManufacturer $proxy) {
