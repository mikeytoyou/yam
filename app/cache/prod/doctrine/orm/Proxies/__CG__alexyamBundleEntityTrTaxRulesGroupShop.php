 ...
 */
class TrTaxRulesGroupShop extends \alex\yamBundle\Entity\TrTaxRulesGroupShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTaxRulesGroupShop' . "\0" . 'idTaxRulesGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrTaxRulesGroupShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrTaxRulesGroupShop $proxy) {
