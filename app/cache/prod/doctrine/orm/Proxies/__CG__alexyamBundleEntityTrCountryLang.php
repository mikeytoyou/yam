 ...
 */
class TrCountryLang extends \alex\yamBundle\Entity\TrCountryLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCountryLang' . "\0" . 'idCountry', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCountryLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCountryLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCountryLang $proxy) {
