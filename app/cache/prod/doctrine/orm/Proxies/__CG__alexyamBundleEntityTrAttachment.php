 ...
 */
class TrAttachment extends \alex\yamBundle\Entity\TrAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttachment' . "\0" . 'idAttachment', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttachment' . "\0" . 'file', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttachment' . "\0" . 'fileName', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttachment' . "\0" . 'fileSize', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttachment' . "\0" . 'mime');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAttachment $proxy) {
