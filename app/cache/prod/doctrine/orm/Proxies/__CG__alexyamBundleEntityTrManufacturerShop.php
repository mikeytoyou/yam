 ...
 */
class TrManufacturerShop extends \alex\yamBundle\Entity\TrManufacturerShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerShop' . "\0" . 'idManufacturer', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrManufacturerShop $proxy) {
