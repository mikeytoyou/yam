 ...
 */
class Incluye extends \alex\yamBundle\Entity\Incluye implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\Incluye' . "\0" . 'id', '' . "\0" . 'alex\\yamBundle\\Entity\\Incluye' . "\0" . 'nombre', '' . "\0" . 'alex\\yamBundle\\Entity\\Incluye' . "\0" . 'valor', '' . "\0" . 'alex\\yamBundle\\Entity\\Incluye' . "\0" . 'paquete');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Incluye $proxy) {
