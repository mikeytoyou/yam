 ...
 */
class TrCartRuleShop extends \alex\yamBundle\Entity\TrCartRuleShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleShop' . "\0" . 'idCartRule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCartRuleShop $proxy) {
