 ...
 */
class TrAlias extends \alex\yamBundle\Entity\TrAlias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAlias' . "\0" . 'idAlias', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAlias' . "\0" . 'alias', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAlias' . "\0" . 'search', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAlias' . "\0" . 'active');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAlias $proxy) {
    ...
    public function getIdAlias()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdAlias();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdAlias', array());

        return parent::getIdAlias();
    }
