 ...
 */
class TrEmployeeShop extends \alex\yamBundle\Entity\TrEmployeeShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrEmployeeShop' . "\0" . 'idEmployee', '' . "\0" . 'alex\\yamBundle\\Entity\\TrEmployeeShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrEmployeeShop $proxy) {
