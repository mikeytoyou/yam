 ...
 */
class TrCurrencyShop extends \alex\yamBundle\Entity\TrCurrencyShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCurrencyShop' . "\0" . 'idCurrency', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCurrencyShop' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCurrencyShop' . "\0" . 'conversionRate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCurrencyShop $proxy) {
