 ...
 */
class TrWarehouseProductLocation extends \alex\yamBundle\Entity\TrWarehouseProductLocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseProductLocation' . "\0" . 'idWarehouseProductLocation', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseProductLocation' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseProductLocation' . "\0" . 'idProductAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseProductLocation' . "\0" . 'idWarehouse', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseProductLocation' . "\0" . 'location');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrWarehouseProductLocation $proxy) {
    ...
    public function getIdWarehouseProductLocation()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdWarehouseProductLocation();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdWarehouseProductLocation', array());

        return parent::getIdWarehouseProductLocation();
    }
