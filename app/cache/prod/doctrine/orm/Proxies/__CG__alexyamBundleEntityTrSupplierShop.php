 ...
 */
class TrSupplierShop extends \alex\yamBundle\Entity\TrSupplierShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierShop' . "\0" . 'idSupplier', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSupplierShop $proxy) {
