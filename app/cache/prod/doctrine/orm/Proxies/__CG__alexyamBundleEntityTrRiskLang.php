 ...
 */
class TrRiskLang extends \alex\yamBundle\Entity\TrRiskLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRiskLang' . "\0" . 'idRisk', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRiskLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRiskLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrRiskLang $proxy) {
