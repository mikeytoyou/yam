 ...
 */
class TrLayeredIndexableAttributeLangValue extends \alex\yamBundle\Entity\TrLayeredIndexableAttributeLangValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredIndexableAttributeLangValue' . "\0" . 'idAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredIndexableAttributeLangValue' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredIndexableAttributeLangValue' . "\0" . 'urlName', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLayeredIndexableAttributeLangValue' . "\0" . 'metaTitle');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrLayeredIndexableAttributeLangValue $proxy) {
