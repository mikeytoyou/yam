 ...
 */
class TrCartRuleLang extends \alex\yamBundle\Entity\TrCartRuleLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleLang' . "\0" . 'idCartRule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCartRuleLang $proxy) {
