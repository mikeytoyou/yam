 ...
 */
class TrAddressFormat extends \alex\yamBundle\Entity\TrAddressFormat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAddressFormat' . "\0" . 'idCountry', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAddressFormat' . "\0" . 'format');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAddressFormat $proxy) {
