 ...
 */
class TrCartProduct extends \alex\yamBundle\Entity\TrCartProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'idCart', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'idAddressDelivery', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'idProductAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'quantity', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartProduct' . "\0" . 'dateAdd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCartProduct $proxy) {
