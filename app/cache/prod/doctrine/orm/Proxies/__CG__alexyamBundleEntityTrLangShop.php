 ...
 */
class TrLangShop extends \alex\yamBundle\Entity\TrLangShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLangShop' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrLangShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrLangShop $proxy) {
