 ...
 */
class TrModuleCountry extends \alex\yamBundle\Entity\TrModuleCountry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCountry' . "\0" . 'idModule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCountry' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCountry' . "\0" . 'idCountry');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrModuleCountry $proxy) {
