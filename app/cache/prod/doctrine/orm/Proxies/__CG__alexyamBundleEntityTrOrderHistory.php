 ...
 */
class TrOrderHistory extends \alex\yamBundle\Entity\TrOrderHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderHistory' . "\0" . 'idOrderHistory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderHistory' . "\0" . 'idEmployee', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderHistory' . "\0" . 'idOrder', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderHistory' . "\0" . 'idOrderState', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderHistory' . "\0" . 'dateAdd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrOrderHistory $proxy) {
    ...
    public function getIdOrderHistory()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdOrderHistory();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdOrderHistory', array());

        return parent::getIdOrderHistory();
    }
    ...
    public function setIdOrderState($idOrderState)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdOrderState', array($idOrderState));

        return parent::setIdOrderState($idOrderState);
    }
