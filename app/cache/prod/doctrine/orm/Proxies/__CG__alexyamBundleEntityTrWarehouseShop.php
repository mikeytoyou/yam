 ...
 */
class TrWarehouseShop extends \alex\yamBundle\Entity\TrWarehouseShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseShop' . "\0" . 'idWarehouse', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrWarehouseShop $proxy) {
