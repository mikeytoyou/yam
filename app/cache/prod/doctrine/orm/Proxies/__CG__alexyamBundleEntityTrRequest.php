 ...
 */
class TrRequest extends \alex\yamBundle\Entity\TrRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRequest' . "\0" . 'llave1', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRequest' . "\0" . 'titulo', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRequest' . "\0" . 'descripcion', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRequest' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRequest' . "\0" . 'dateUpd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrRequest $proxy) {
    ...
    public function getLlave1()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getLlave1();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLlave1', array());

        return parent::getLlave1();
    }
