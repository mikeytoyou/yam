 ...
 */
class TrSearchWord extends \alex\yamBundle\Entity\TrSearchWord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSearchWord' . "\0" . 'idWord', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSearchWord' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSearchWord' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSearchWord' . "\0" . 'word');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSearchWord $proxy) {
