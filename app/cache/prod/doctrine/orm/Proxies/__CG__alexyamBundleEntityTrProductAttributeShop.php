 ...
 */
class TrProductAttributeShop extends \alex\yamBundle\Entity\TrProductAttributeShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'idProductAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'wholesalePrice', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'price', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'ecotax', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'weight', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'unitPriceImpact', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'defaultOn', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'minimalQuantity', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeShop' . "\0" . 'availableDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrProductAttributeShop $proxy) {
