 ...
 */
class TrProductSale extends \alex\yamBundle\Entity\TrProductSale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductSale' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductSale' . "\0" . 'quantity', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductSale' . "\0" . 'saleNbr', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductSale' . "\0" . 'dateUpd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrProductSale $proxy) {
    ...
    public function setSaleNbr($saleNbr)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSaleNbr', array($saleNbr));

        return parent::setSaleNbr($saleNbr);
    }
    ...
    public function getSaleNbr()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSaleNbr', array());

        return parent::getSaleNbr();
    }
