 ...
 */
class TrCompareProduct extends \alex\yamBundle\Entity\TrCompareProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCompareProduct' . "\0" . 'idCompare', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCompareProduct' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCompareProduct' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCompareProduct' . "\0" . 'dateUpd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCompareProduct $proxy) {
    ...
    public function setIdCompare($idCompare)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdCompare', array($idCompare));

        return parent::setIdCompare($idCompare);
    }
    ...
    public function getIdCompare()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCompare();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCompare', array());

        return parent::getIdCompare();
    }
