 ...
 */
class TrWebserviceAccount extends \alex\yamBundle\Entity\TrWebserviceAccount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'idWebserviceAccount', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'key', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'description', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'className', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'isModule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'moduleName', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWebserviceAccount' . "\0" . 'active');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrWebserviceAccount $proxy) {
    ...
    public function getIdWebserviceAccount()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdWebserviceAccount();
        }
