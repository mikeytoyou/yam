 ...
 */
class TrShopGroup extends \alex\yamBundle\Entity\TrShopGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'idShopGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'shareCustomer', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'shareOrder', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'shareStock', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'active', '' . "\0" . 'alex\\yamBundle\\Entity\\TrShopGroup' . "\0" . 'deleted');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrShopGroup $proxy) {
    ...
    public function getIdShopGroup()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdShopGroup();
        }
