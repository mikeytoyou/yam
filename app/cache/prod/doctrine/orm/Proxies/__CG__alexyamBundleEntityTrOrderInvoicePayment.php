 ...
 */
class TrOrderInvoicePayment extends \alex\yamBundle\Entity\TrOrderInvoicePayment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderInvoicePayment' . "\0" . 'idOrderInvoice', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderInvoicePayment' . "\0" . 'idOrderPayment', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderInvoicePayment' . "\0" . 'idOrder');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrOrderInvoicePayment $proxy) {
    ...
    public function setIdOrderPayment($idOrderPayment)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdOrderPayment', array($idOrderPayment));

        return parent::setIdOrderPayment($idOrderPayment);
    }
