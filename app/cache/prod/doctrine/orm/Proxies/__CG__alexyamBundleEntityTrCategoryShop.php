 ...
 */
class TrCategoryShop extends \alex\yamBundle\Entity\TrCategoryShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryShop' . "\0" . 'idCategory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryShop' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryShop' . "\0" . 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCategoryShop $proxy) {
