 ...
 */
class TrWarehouseCarrier extends \alex\yamBundle\Entity\TrWarehouseCarrier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseCarrier' . "\0" . 'idWarehouse', '' . "\0" . 'alex\\yamBundle\\Entity\\TrWarehouseCarrier' . "\0" . 'idCarrier');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrWarehouseCarrier $proxy) {
