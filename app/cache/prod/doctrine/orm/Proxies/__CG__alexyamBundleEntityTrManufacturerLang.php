 ...
 */
class TrManufacturerLang extends \alex\yamBundle\Entity\TrManufacturerLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'idManufacturer', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'description', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'shortDescription', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'metaTitle', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'metaKeywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrManufacturerLang' . "\0" . 'metaDescription');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrManufacturerLang $proxy) {
    ...
    public function getIdManufacturer()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdManufacturer();
        }
