 ...
 */
class TrStockMvtReason extends \alex\yamBundle\Entity\TrStockMvtReason implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReason' . "\0" . 'idStockMvtReason', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReason' . "\0" . 'sign', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReason' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReason' . "\0" . 'dateUpd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReason' . "\0" . 'deleted');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrStockMvtReason $proxy) {
    ...
    public function getIdStockMvtReason()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdStockMvtReason();
        }
