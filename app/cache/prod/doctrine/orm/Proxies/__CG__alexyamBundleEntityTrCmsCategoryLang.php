 ...
 */
class TrCmsCategoryLang extends \alex\yamBundle\Entity\TrCmsCategoryLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'idCmsCategory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'description', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'linkRewrite', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'metaTitle', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'metaKeywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCmsCategoryLang' . "\0" . 'metaDescription');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCmsCategoryLang $proxy) {
    ...
    public function getIdCmsCategory()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCmsCategory();
        }
