 ...
 */
class TrImage extends \alex\yamBundle\Entity\TrImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImage' . "\0" . 'idImage', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImage' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImage' . "\0" . 'position', '' . "\0" . 'alex\\yamBundle\\Entity\\TrImage' . "\0" . 'cover');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrImage $proxy) {
