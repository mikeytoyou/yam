 ...
 */
class TrConfigurationKpi extends \alex\yamBundle\Entity\TrConfigurationKpi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'idConfigurationKpi', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'idShopGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'value', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'dateAdd', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationKpi' . "\0" . 'dateUpd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrConfigurationKpi $proxy) {
