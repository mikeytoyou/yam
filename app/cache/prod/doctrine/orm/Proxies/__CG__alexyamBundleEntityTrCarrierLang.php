 ...
 */
class TrCarrierLang extends \alex\yamBundle\Entity\TrCarrierLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierLang' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierLang' . "\0" . 'idCarrier', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierLang' . "\0" . 'delay');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCarrierLang $proxy) {
