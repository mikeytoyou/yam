 ...
 */
class TrCartRuleCountry extends \alex\yamBundle\Entity\TrCartRuleCountry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleCountry' . "\0" . 'idCartRule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleCountry' . "\0" . 'idCountry');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCartRuleCountry $proxy) {
