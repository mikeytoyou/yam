 ...
 */
class TrProductAttributeCombination extends \alex\yamBundle\Entity\TrProductAttributeCombination implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeCombination' . "\0" . 'idAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductAttributeCombination' . "\0" . 'idProductAttribute');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrProductAttributeCombination $proxy) {
