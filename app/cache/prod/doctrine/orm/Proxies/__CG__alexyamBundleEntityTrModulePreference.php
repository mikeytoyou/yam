 ...
 */
class TrModulePreference extends \alex\yamBundle\Entity\TrModulePreference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModulePreference' . "\0" . 'idModulePreference', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModulePreference' . "\0" . 'idEmployee', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModulePreference' . "\0" . 'module', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModulePreference' . "\0" . 'interest', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModulePreference' . "\0" . 'favorite');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrModulePreference $proxy) {
    ...
    public function getIdModulePreference()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdModulePreference();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdModulePreference', array());

        return parent::getIdModulePreference();
    }
