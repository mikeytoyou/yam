 ...
 */
class TrRisk extends \alex\yamBundle\Entity\TrRisk implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRisk' . "\0" . 'idRisk', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRisk' . "\0" . 'percent', '' . "\0" . 'alex\\yamBundle\\Entity\\TrRisk' . "\0" . 'color');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrRisk $proxy) {
