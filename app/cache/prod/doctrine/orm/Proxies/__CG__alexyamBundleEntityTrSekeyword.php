 ...
 */
class TrSekeyword extends \alex\yamBundle\Entity\TrSekeyword implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSekeyword' . "\0" . 'idSekeyword', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSekeyword' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSekeyword' . "\0" . 'idShopGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSekeyword' . "\0" . 'keyword', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSekeyword' . "\0" . 'dateAdd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSekeyword $proxy) {
    ...
    public function getIdSekeyword()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdSekeyword();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdSekeyword', array());

        return parent::getIdSekeyword();
    }
