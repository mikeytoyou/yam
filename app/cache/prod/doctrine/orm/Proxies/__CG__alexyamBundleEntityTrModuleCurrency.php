 ...
 */
class TrModuleCurrency extends \alex\yamBundle\Entity\TrModuleCurrency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCurrency' . "\0" . 'idModule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCurrency' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleCurrency' . "\0" . 'idCurrency');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrModuleCurrency $proxy) {
