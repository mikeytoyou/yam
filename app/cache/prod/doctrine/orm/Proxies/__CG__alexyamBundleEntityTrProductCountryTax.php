 ...
 */
class TrProductCountryTax extends \alex\yamBundle\Entity\TrProductCountryTax implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductCountryTax' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductCountryTax' . "\0" . 'idCountry', '' . "\0" . 'alex\\yamBundle\\Entity\\TrProductCountryTax' . "\0" . 'idTax');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrProductCountryTax $proxy) {
