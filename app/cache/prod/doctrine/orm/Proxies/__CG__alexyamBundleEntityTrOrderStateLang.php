 ...
 */
class TrOrderStateLang extends \alex\yamBundle\Entity\TrOrderStateLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderStateLang' . "\0" . 'idOrderState', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderStateLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderStateLang' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrOrderStateLang' . "\0" . 'template');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrOrderStateLang $proxy) {
