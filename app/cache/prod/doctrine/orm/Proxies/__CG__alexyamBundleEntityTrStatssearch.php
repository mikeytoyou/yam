 ...
 */
class TrStatssearch extends \alex\yamBundle\Entity\TrStatssearch implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'idStatssearch', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'idShopGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'keywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'results', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStatssearch' . "\0" . 'dateAdd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrStatssearch $proxy) {
    ...
    public function getIdStatssearch()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdStatssearch();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdStatssearch', array());

        return parent::getIdStatssearch();
    }
