 ...
 */
class TrCartRuleGroup extends \alex\yamBundle\Entity\TrCartRuleGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleGroup' . "\0" . 'idCartRule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCartRuleGroup' . "\0" . 'idGroup');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCartRuleGroup $proxy) {
