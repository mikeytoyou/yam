 ...
 */
class TrSupplierLang extends \alex\yamBundle\Entity\TrSupplierLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'idSupplier', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'description', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'metaTitle', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'metaKeywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrSupplierLang' . "\0" . 'metaDescription');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrSupplierLang $proxy) {
