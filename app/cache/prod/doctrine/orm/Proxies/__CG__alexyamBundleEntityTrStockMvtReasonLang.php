 ...
 */
class TrStockMvtReasonLang extends \alex\yamBundle\Entity\TrStockMvtReasonLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReasonLang' . "\0" . 'idStockMvtReason', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReasonLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrStockMvtReasonLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrStockMvtReasonLang $proxy) {
