 ...
 */
class TrAttributeLang extends \alex\yamBundle\Entity\TrAttributeLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeLang' . "\0" . 'idAttribute', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrAttributeLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrAttributeLang $proxy) {
