 ...
 */
class TrConfigurationLang extends \alex\yamBundle\Entity\TrConfigurationLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationLang' . "\0" . 'idConfiguration', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationLang' . "\0" . 'value', '' . "\0" . 'alex\\yamBundle\\Entity\\TrConfigurationLang' . "\0" . 'dateUpd');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrConfigurationLang $proxy) {
    ...
    public function setIdConfiguration($idConfiguration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdConfiguration', array($idConfiguration));

        return parent::setIdConfiguration($idConfiguration);
    }
