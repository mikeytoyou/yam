 ...
 */
class TrGenderLang extends \alex\yamBundle\Entity\TrGenderLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrGenderLang' . "\0" . 'idGender', '' . "\0" . 'alex\\yamBundle\\Entity\\TrGenderLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrGenderLang' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrGenderLang $proxy) {
