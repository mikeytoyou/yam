 ...
 */
class Hotel extends \alex\yamBundle\Entity\Hotel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\Hotel' . "\0" . 'id', '' . "\0" . 'alex\\yamBundle\\Entity\\Hotel' . "\0" . 'nombre', '' . "\0" . 'alex\\yamBundle\\Entity\\Hotel' . "\0" . 'categoria');
        }
