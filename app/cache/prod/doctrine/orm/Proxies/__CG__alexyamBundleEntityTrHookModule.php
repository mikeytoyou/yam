 ...
 */
class TrHookModule extends \alex\yamBundle\Entity\TrHookModule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrHookModule' . "\0" . 'idModule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrHookModule' . "\0" . 'idHook', '' . "\0" . 'alex\\yamBundle\\Entity\\TrHookModule' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrHookModule' . "\0" . 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrHookModule $proxy) {
