 ...
 */
class TrModuleGroup extends \alex\yamBundle\Entity\TrModuleGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleGroup' . "\0" . 'idModule', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleGroup' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrModuleGroup' . "\0" . 'idGroup');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrModuleGroup $proxy) {
