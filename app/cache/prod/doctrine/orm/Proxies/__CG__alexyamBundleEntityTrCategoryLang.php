 ...
 */
class TrCategoryLang extends \alex\yamBundle\Entity\TrCategoryLang implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'idCategory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'idShop', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'idLang', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'name', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'description', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'linkRewrite', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'metaTitle', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'metaKeywords', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryLang' . "\0" . 'metaDescription');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCategoryLang $proxy) {
