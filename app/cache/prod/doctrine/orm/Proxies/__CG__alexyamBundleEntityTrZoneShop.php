 ...
 */
class TrZoneShop extends \alex\yamBundle\Entity\TrZoneShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrZoneShop' . "\0" . 'idZone', '' . "\0" . 'alex\\yamBundle\\Entity\\TrZoneShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrZoneShop $proxy) {
