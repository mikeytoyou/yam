 ...
 */
class TrCarrierTaxRulesGroupShop extends \alex\yamBundle\Entity\TrCarrierTaxRulesGroupShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierTaxRulesGroupShop' . "\0" . 'idCarrier', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierTaxRulesGroupShop' . "\0" . 'idTaxRulesGroup', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCarrierTaxRulesGroupShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCarrierTaxRulesGroupShop $proxy) {
    ...
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTaxRulesGroup();
        }
