 ...
 */
class TrCategoryProduct extends \alex\yamBundle\Entity\TrCategoryProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryProduct' . "\0" . 'idCategory', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryProduct' . "\0" . 'idProduct', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCategoryProduct' . "\0" . 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCategoryProduct $proxy) {
