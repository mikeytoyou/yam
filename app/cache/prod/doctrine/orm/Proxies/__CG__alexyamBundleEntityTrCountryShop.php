 ...
 */
class TrCountryShop extends \alex\yamBundle\Entity\TrCountryShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCountryShop' . "\0" . 'idCountry', '' . "\0" . 'alex\\yamBundle\\Entity\\TrCountryShop' . "\0" . 'idShop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrCountryShop $proxy) {
